...
public class GameScreen implements Screen {
    ...
    private static final float BALL_VELOCITY_START     = WORLD_HEIGHT / 2f;
    private static final float BALL_VELOCITY_MAX       = WORLD_HEIGHT;
    private static final float BALL_VELOCITY_INCREMENT = WORLD_HEIGHT / 16f;
    ...
    private static final float PADDLE_POSITION_X = WORLD_WIDTH/2f - PADDLE_SIZE_X/2f;
    private static final float PADDLE_POSITION_Y = WORLD_HEIGHT/12f;
    ...
    private static final float PADDLE_ENEMY_POSITION_X = WORLD_WIDTH/2f - PADDLE_ENEMY_SIZE_X/2f;
    private static final float PADDLE_ENEMY_POSITION_Y = WORLD_HEIGHT - PADDLE_ENEMY_SIZE_Y - WORLD_WIDTH / 8f;
    ...
    private int paddleContact    = 0;
    private boolean isPaddleGoal = false;
    ...
    public void show() {
        ...
        world.setContactListener(new ContactListener() {
            ...
            public void beginContact(Contact contact) {
                //-----------------------------------------------------------//
                //             Encuentro de raquetas de jugadores            //
                //-----------------------------------------------------------//
                ...
                //-----------------------------------------------------//
                //          Colisión con una raqueta enemiga           //
                //-----------------------------------------------------//
    ...
    public void render(float delta) {
        ...
        if (this.gameActive) {
            ...
            //-------------------------------------------------------------------//
            //           Verificando las ganancias, el final de la ronda         //
            //-------------------------------------------------------------------//
            ...
            //------------------------------------------------------------------//
            //   Aumenta la velocidad de la pelota en 5 golpes en la raqueta    //
            //------------------------------------------------------------------//
